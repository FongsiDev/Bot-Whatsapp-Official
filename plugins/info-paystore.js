      ...
      rows: [
        {
          ...
          description: "PRICE: " + sh + "k (1 minggu)",
        },
        {
          title: "🔖 NORMAL",
          rowId: ".order *Paket:* NORMAL • Sewa",
          description: "PRICE: " + sn + "k (1 bulan)",
        },
        {
          title: "🔖 STANDAR",
          rowId: ".order *Paket:* STANDAR • Sewa",
          description: "PRICE: " + ss + "k (2 bulan)",
        },
        {
          title: "🔖 PRO",
          rowId: ".order *Paket:* PRO • Sewa",
          description: "PRICE: " + sp + "k (4 bulan)",
        },
        {
          title: "🔖 VIP",
          rowId: ".order *Paket:* VIP • Sewa",
          description: "PRICE: " + sv + "k (12 bulan)",
        },
      ],
    },
    {
      ...
      rows: [
        ...
        },
        {
          ...
          description: "PRICE: " + pn + "k (1 bulan)",
        },
        {
          title: "🌟 PRO",
          rowId: ".order *Paket:* PRO • Premium",
          description: "PRICE: " + pp + "k (4 bulan)",
        },
        {
          title: "🌟 VIP",
          rowId: ".order *Paket:* VIP • Premium",
          description: "PRICE: " + pv + "k (8 bulan)",
        },
        {
          title: "🌟 PERMANENT (jual script bot)",
          rowId: ".order *Paket:* PERMANENT • Premium (jual script bot)",
          description: "PRICE: " + ppm + "k (UNLIMITED)",
        },
      ],
    },
  ];
