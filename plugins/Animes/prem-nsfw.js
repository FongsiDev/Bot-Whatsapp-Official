  ...
  const sections = [
    {
      ...
      rows: [
        {
          title:
            `${(ch == true ? false : ahegao) == true ? p : f}` + "A • Ahegao",
          rowId: ".nsfw ahegao",
        },
        {
          title: `${(ch == true ? false : anal) == true ? p : f}` + "A • Anal",
          rowId: ".nsfw anal",
        },
        {
          title: `${(ch == true ? false : ass) == true ? p : f}` + "A • Ass",
          rowId: ".nsfw ass",
        },
        {
          title:
            `${(ch == true ? false : blowjob) == true ? p : f}` + "B • BlowJob",
          rowId: ".nsfw blowjob",
        },
        {
          title:
            `${(ch == true ? false : cums) == true ? p : f}` + "C • Cumsluts",
          rowId: ".nsfw cums",
        },
        {
          title:
            `${(ch == true ? false : ecchi) == true ? p : f}` + "E • Ecchi",
          rowId: ".nsfw ecchi",
        },
        {
          title: `${(ch == true ? false : ero) == true ? p : f}` + "E • Ero",
          rowId: ".nsfw ero",
        },
        //{title: `${(ch == true ? false : erofeet) == true ? p:f}` + "E • Ero Feet", rowId: ".nsfw erofeet"},
        {
          title:
            `${(ch == true ? false : erogirl) == true ? p : f}` +
            "E • Ero Girl",
          rowId: ".nsfw erogirl",
        },
        {
          title:
            `${(ch == true ? false : holoero) == true ? p : f}` +
            "E • Ero Holo",
          rowId: ".nsfw holoero",
        },
        ...
        {
          title: `${(ch == true ? false : feet) == true ? p : f}` + "F • Feet",
          rowId: ".nsfw feet",
        },
        {
          title:
            `${(ch == true ? false : femdom) == true ? p : f}` + "F • Femdom",
          rowId: ".nsfw femdom",
        },
        {
          title:
            `${(ch == true ? false : futanari) == true ? p : f}` +
            "F • Futanari",
          rowId: ".nsfw futanari",
        },
        ...
        {
          title:
            `${(ch == true ? false : hentai) == true ? p : f}` + "H • Hentai",
          rowId: ".nsfw hentai",
        },
        {
          title: `${(ch == true ? false : holo) == true ? p : f}` + "H • Holo",
          rowId: ".nsfw holo",
        },
        {
          title: `${(ch == true ? false : jahy) == true ? p : f}` + "J • Jahy",
          rowId: ".nsfw jahy",
        },
        ...
        {
          title: `${(ch == true ? false : loli) == true ? p : f}` + "L • Loli",
          rowId: ".nsfw loli",
        },
        {
          title:
            `${(ch == true ? false : manga) == true ? p : f}` + "M • Manga",
          rowId: ".nsfw manga",
        },
        {
          title: `${(ch == true ? false : milf) == true ? p : f}` + "M • Milf",
          rowId: ".nsfw milf",
        },
        {
          title:
            `${(ch == true ? false : mstrb) == true ? p : f}` + "M • Mstrb",
          rowId: ".nsfw mstrb",
        },
        {
          title: `${(ch == true ? false : neko) == true ? p : f}` + "N • Neko",
          rowId: ".nsfw neko",
        },
        {
          title:
            `${(ch == true ? false : oppai) == true ? p : f}` + "O • Oppai",
          rowId: ".nsfw oppai",
        },
        {
          title:
            `${(ch == true ? false : panties) == true ? p : f}` + "P • Panties",
          rowId: ".nsfw panties",
        },
        {
          title:
            `${(ch == true ? false : pussy) == true ? p : f}` + "P • Pussy",
          rowId: ".nsfw pussy",
        },
        //{title: `${(ch == true ? false : spank) == true ? p:f}` + "S • Spank", rowId: ".nsfw spank"},
        {
          title:
            `${(ch == true ? false : tentacles) == true ? p : f}` +
            "T • Tentacles",
          rowId: ".nsfw tentacles",
        },
        {
          title:
            `${(ch == true ? false : thighs) == true ? p : f}` + "T • Thighs",
          rowId: ".nsfw thighs",
        },
        //{title: `${(ch == true ? false : tits) == true ? p:f}` + "T • Tits", rowId: ".nsfw tits"},
        {
          title: `${(ch == true ? false : trap) == true ? p : f}` + "T • Trap",
          rowId: ".nsfw trap",
        },
        {
          title:
            `${(ch == true ? false : uniform) == true ? p : f}` + "U • Uniform",
          rowId: ".nsfw uniform",
        },
        {
          title:
            `${(ch == true ? false : waifu) == true ? p : f}` + "W • Waifu",
          rowId: ".nsfw waifu",
        },
        {
          title: `${(ch == true ? false : yaoi) == true ? p : f}` + "Y • Yaoi",
          rowId: ".nsfw yaoi",
        },
        {
          title: `${(ch == true ? false : yuri) == true ? p : f}` + "Y • Yuri",
          rowId: ".nsfw yuri",
        },
      ],
    },
      ...
      switch (type) {
        case "ahegao":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(xres + "ahegao" + xapi)).buffer(),
        ...
        case "anal":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(resl + "anal" + apil)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "ass":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(xres + "ass" + xapi)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "blowjob":
          ...
          let bj = await (
            await fetch(`https://api.waifu.pics/nsfw/blowjob`)
          ).json();
          conn.sendButton(
            m.chat,
            tekk,
        ...
        case "cums":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(resl + "cum" + apil)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "ecchi":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(res + "ecchi" + api)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "ero":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(xres + "ero" + xapi)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "erofeet":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(res + "feet" + api)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "erogirl":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(res + "lewdanimegirls" + api)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "holoero":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(res + "holo" + api)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "erokitsune":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(resl + "erok" + apil)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "eroneko":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(resl + "eron" + apil)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "eroyuri":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(res + "eroYuri" + api)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "futanari":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(res + "futanari" + api)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "girlsolo":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(resl + "solo" + apil)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "hentai":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(xres + "hentai" + xapi)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "holo":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(res + "hololewd" + api)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "jahy":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(xres + "jahy" + xapi)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "kitsune":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(res + "kitsune" + api)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "kuni":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(resl + "kuni" + apil)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "loli":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(res + "loli" + api)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "manga":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(xres + "manga" + xapi)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "milf":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(res + "milf" + api)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "mstrb":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(xres + "mstrb" + xapi)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "neko":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(xres + "nsfwneko" + xapi)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "oppai":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(res + "sideoppai" + api)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "panties":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(xres + "panties" + xapi)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "pussy":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(xres + "pussy" + xapi)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "spank":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(res + "spank" + api)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "tentacles":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(xres + "tentacles" + xapi)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "tits":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(res + "tits" + api)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "thighs":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(xres + "thighs" + xapi)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "trap":
          ...
          let tr = await (
            await fetch(`https://api.waifu.pics/nsfw/trap`)
          ).json();
          conn.sendButton(
            m.chat,
            tekk,
        ...
        case "uniform":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(xres + "uniform" + xapi)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
        ...
        case "yaoi":
          ...
          conn.sendButton(
            ...
            tekk,
            fot,
            await (await fetch(res + "yaoi" + api)).buffer(),
            [[next, `${usedPrefix}nsfw ${args[0]}`]],
            m
          );
          break;
