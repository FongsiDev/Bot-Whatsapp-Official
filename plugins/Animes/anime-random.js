...
let handler = async (m, { command, conn }) => {
  if (command == "akira") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/akira?apikey=APIKEY`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "akiyama") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/akiyama?apikey=APIKEY`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "anna") {
    let haha = await conn.getFile(
      `https://api.sekha.tech/api/wallpaper/ana?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "asuna") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/asuna?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "ayuzawa") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/ayuzawa?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "boruto") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/boruto?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "chiho") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/chiho?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "chitoge") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/chitoge?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "deidara") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/deidara?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "erza") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/erza?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "elaina") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/elaina?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "eba") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/eba?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "emilia") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/emilia?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "hestia") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/hestia?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "hinata") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/hinata?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "inori") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/inori?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "isuzu") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/isuzu?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "itachi") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/itachi?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "itori") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/itori?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "kaga") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/kaga?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "kagura") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/kagura?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "kaori") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/kaori?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "keneki") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/keneki?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "kotori") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/kotori?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "kurumi") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/kurumi?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "madara") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/madara?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "mikasa") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/mikasa?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "miku") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/miku?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "minato") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/minato?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "naruto") {
    let haha = await conn.getFile(
      `https://raw.githubusercontent.com/inirey/RESTAPI/master/data/naruto.json`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "sagiri") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/sagiri?apikey=APIKEY`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "sakura") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/wallpaper/sakura?apikey=APIKEY`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
  ...
  if (command == "cosplay") {
    let haha = await conn.getFile(
      `https://api-reysekha.herokuapp.com/api/random/cosplay?apikey=apirey`
    );
    conn.sendButton(
      m.chat,
      `_${command}_`.trim(),
