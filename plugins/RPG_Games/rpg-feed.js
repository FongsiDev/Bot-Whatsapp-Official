...
`;
  switch (type) {
    ...
    case "rhinoceros":
      ...
      let wbadak =
        new Date() - global.db.data.users[m.sender].rhinoceroslastclaim;
    ...
    case "dragon":
      ...
      if (
        new Date() - global.db.data.users[m.sender].dragonlastclaim >
        600000
      ) {
    ...
    case "centaur":
      ...
      let wcentaur =
        new Date() - global.db.data.users[m.sender].centaurlastclaim;
    ...
    case "phonix":
      ...
      if (
        new Date() - global.db.data.users[m.sender].phonixlastclaim >
        600000
      ) {
    ...
    case "griffin":
      ...
      let wgriffin =
        new Date() - global.db.data.users[m.sender].griffinastclaim;
      let wgriffina = 600000 - wgriffin;
      let wgriffinaa = clockString(wgriffina);
      if (
        new Date() - global.db.data.users[m.sender].griffinlastclaim >
        600000
      ) {
