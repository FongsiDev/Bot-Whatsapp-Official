import daily from "../RPG_Games/rpg-daily.js";
import weekly from "../RPG_Games/rpg-weekly.js";
import monthly from "../RPG_Games/rpg-monthly.js";
import adventure from "../RPG_Games/rpg-adventure.js";
  ...
  if (!args[0]) {
    const sections = [
      ...
      },
      {
        ...
        rows: [
          {
            title: dmenub + "Kolam 1",
            rowId: usedPrefix + command + " invkolam",
          },
...
╰┫Phonix ${
      phonix == 0
        ? "Tidak Punya"
        : "" || (phonix > 0 && phonix < 15)
        ? `Level *${phonix}* To level *${phonix + 1}*\n╭┫Exp *${_phonix}* -> *${
            phonix * 10000
          }*`
        : "" || phonix == 15
        ? "*Max Level*"
