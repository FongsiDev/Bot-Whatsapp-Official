let handler = async (m, { conn, command, args, text, usedPrefix }) => {
  ...
  let Lmao = `Hanya support 1, 10, 100, 1000\nContoh penggunaan: *${usedPrefix}open ${
    args > 2 ? _lmao : pickRandom(["common", "uncommon", "mythic", "legendary"])
  } 10*`;
      ...
      switch (jumlah) {
        ...
        case "crate":
          ...
          if (new Date() - global.db.data.users[m.sender].lastopen > 30000) {
            ...
            let ebz = _ebz * 1;
            let Mychatz = `
Anda telah membuka *Boxs crate* dan mendapatkan:${
              mmz > 0 ? `\nMoney: ${mmz}` : ""
            }${mez > 0 ? `\nExp: ${mez} *exp*` : ""}${
      ...
      switch (jumlah) {
        ...
        case "crate":
          ...
          if (new Date() - global.db.data.users[m.sender].lastopen > 30000) {
            ...
            let elp = _elp * 1;
            let Mychatzi = `
Anda telah membuka *Gardenboxs crate* dan mendapatkan:${
              alp > 0 ? `\nBibitmangga: ${alp}` : ""
            }${dlp > 0 ? `\nBibitpisang: ${dlp}` : ""}${
              elp > 0 ? `\nBibitanggur: ${elp}` : ""
            }${clp > 0 ? `\nBibitjeruk: ${clp}` : ""}${
      ...
      switch (jumlah) {
        ...
        case "crate":
          ...
          if (new Date() - global.db.data.users[m.sender].lastopen > 30000) {
            ...
            let mci = 50000;
            let Mochat = `
Anda telah membuka *Cupon crate* dan mendapatkan:${
              mm > 0 ? `\nMoney: ${mm} *money*` : ""
            }${me > 0 ? `\nExp: ${me} *exp*` : ""}${
              mp > 0 ? `\nLimit: ${mp} *limit*` : ""
