          ...
          switch (_type) {
            ...
            case "anggur":
              if (global.db.data.users[m.sender].money >= Banggur * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Anggur dengan harga ${
                    Banggur * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} anggur dengan harga ${
                    Banggur * count
                  } money`.trim(),
                  m
                );
            ...
            case "mangga":
              if (global.db.data.users[m.sender].money >= Bmangga * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Mangga dengan harga ${
                    Bmangga * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} mangga dengan harga ${
                    Bmangga * count
                  } money`.trim(),
                  m
                );
            ...
            case "jeruk":
              if (global.db.data.users[m.sender].money >= Bjeruk * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Jeruk dengan harga ${
                    Bjeruk * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} jeruk dengan harga ${
                    Bjeruk * count
                  } money`.trim(),
                  m
                );
            ...
            case "apel":
              if (global.db.data.users[m.sender].money >= Bapel * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Apel dengan harga ${
                    Bapel * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} apel dengan harga ${
                    Bapel * count
                  } money`.trim(),
                  m
                );
            ...
            case "bibitpisang":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Bibit Pisang dengan harga ${
                    Bbibitpisang * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} bibit pisang dengan harga ${
                    Bbibitpisang * count
                  } money`.trim(),
                  m
                );
            ...
            case "bibitanggur":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Bibit Anggur dengan harga ${
                    Bbibitanggur * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} bibit anggur dengan harga ${
                    Bbibitanggur * count
                  } money`.trim(),
                  m
                );
            ...
            case "bibitmangga":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Bibit Mangga dengan harga ${
                    Bbibitmangga * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} bibit mangga dengan harga ${
                    Bbibitmangga * count
                  } money`.trim(),
                  m
                );
            ...
            case "bibitjeruk":
              if (global.db.data.users[m.sender].money >= Bbibitjeruk * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Bibit Jeruk dengan harga ${
                    Bbibitjeruk * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} bibit jeruk dengan harga ${
                    Bbibitjeruk * count
                  } money`.trim(),
                  m
                );
            ...
            case "bibitapel":
              if (global.db.data.users[m.sender].money >= Bbibitapel * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Bibit Apel dengan harga ${
                    Bbibitapel * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} bibit apel dengan harga ${
                    Bbibitapel * count
                  } money`.trim(),
                  m
                );
            ...
            case "gardenboxs":
              if (global.db.data.users[m.sender].money >= Bgardenboxs * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Gardenboxs dengan harga ${
                    Bgardenboxs * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} gardenboxs dengan harga ${
                    Bgardenboxs * count
                  } money`.trim(),
                  m
                );
            ...
            case "berlian":
              if (global.db.data.users[m.sender].money >= Bberlian * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Berlian dengan harga ${
                    Bberlian * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} berlian dengan harga ${
                    Bberlian * count
                  } money`.trim(),
                  m
                );
            ...
            case "emas":
              if (global.db.data.users[m.sender].money >= Bemasbiasa * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Emas dengan harga ${
                    Bemasbiasa * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} emas dengan harga ${
                    Bemasbiasa * count
                  } money`.trim(),
                  m
                );
            ...
            case "pet":
              if (global.db.data.users[m.sender].money >= Bpet * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Pet Random dengan harga ${
                    Bpet * count
                  } money`,
                  m
                );
            ...
            case "cupon":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} cupon dengan harga ${
                    Btiketcoin * count
                  } Tiketcoin`,
                  m
                );
            ...
            case "makananpet":
              if (global.db.data.users[m.sender].money >= Bmakananpet * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Makanan Pet dengan harga ${
                    Bmakananpet * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} makanan pet dengan harga ${
                    Bmakananpet * count
                  } money`.trim(),
                  m
                );
            ...
            case "makanannaga":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Makanan Naga dengan harga ${
                    Bmakanannaga * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} makanan naga dengan harga ${
                    Bmakanannaga * count
                  } money`.trim(),
                  m
                );
            ...
            case "makananphonix":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Makanan Phonix dengan harga ${
                    Bmakananphonix * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} makanan phonix dengan harga ${
                    Bmakananphonix * count
                  } money`.trim(),
                  m
                );
            ...
            case "makanankyubi":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Makanan Kyubi dengan harga ${
                    Bmakanankyubi * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} makanan kyubi dengan harga ${
                    Bmakanankyubi * count
                  } money`.trim(),
                  m
                );
            ...
            case "makanangriffin":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Makanan Griffin dengan harga ${
                    Bmakanangriffin * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} makanan griffin dengan harga ${
                    Bmakanangriffin * count
                  } money`.trim(),
                  m
                );
            ...
            case "makanancentaur":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Makanan Centaur dengan harga ${
                    Bmakanancentaur * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} makanan centaur dengan harga ${
                    Bmakanancentaur * count
                  } money`.trim(),
                  m
                );
            ...
            case "tiketm":
              if (
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} TiketM dengan harga ${
                    Bhealtmonster * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} tiketm dengan harga ${
                    Bhealtmonster * count
                  } money`.trim(),
                  m
                );
            ...
            case "aqua":
              if (global.db.data.users[m.sender].money >= Baqua * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Aqua dengan harga ${
                    Baqua * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} aqua dengan harga ${
                    Baqua * count
                  } money`.trim(),
                  m
                );
            ...
            case "iron":
              if (global.db.data.users[m.sender].money >= Biron * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Iron dengan harga ${
                    Biron * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} iron dengan harga ${
                    Biron * count
                  } money`.trim(),
                  m
                );
            ...
            case "string":
              if (global.db.data.users[m.sender].money >= Bstring * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} String dengan harga ${
                    Bstring * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} string dengan harga ${
                    Bstring * count
                  } money`.trim(),
                  m
                );
            ...
            case "sword":
              if (global.db.data.users[m.sender].money >= Bsword * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Sword dengan harga ${
                    Bsword * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} sword dengan harga ${
                    Bsword * count
                  } money`.trim(),
                  m
                );
            ...
            case "batu":
              if (global.db.data.users[m.sender].money >= Bbatu * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Batu dengan harga ${
                    Bbatu * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} batu dengan harga ${
                    Bbatu * count
                  } money`.trim(),
                  m
                );
            ...
            case "umpan":
              if (global.db.data.users[m.sender].money >= Bumpan * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Umpan dengan harga ${
                    Bumpan * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} umpan dengan harga ${
                    Bumpan * count
                  } money`.trim(),
                  m
                );
            ...
            case "pancingan":
              if (global.db.data.users[m.sender].money >= Bpancingan * count) {
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} pancingan dengan harga ${
                    Bpancingan * count
                  } money`.trim(),
                  m
                );
          ...
          switch (_type) {
            ...
            case "kaleng":
              if (global.db.data.users[m.sender].kaleng >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} kaleng, dan anda mendapatkan ${
                    Skaleng * count
                  } money`,
                  m
                );
            ...
            case "kardus":
              if (global.db.data.users[m.sender].kardus >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} kardus, dan anda mendapatkan ${
                    Skardus * count
                  } money`,
                  m
                );
            ...
            case "botol":
              if (global.db.data.users[m.sender].botol >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} botol, dan anda mendapatkan ${
                    Sbotol * count
                  } money`,
                  m
                );
            ...
            case "kayu":
              if (global.db.data.users[m.sender].kayu >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} kayu, dan anda mendapatkan ${
                    Skayu * count
                  } money`,
                  m
                );
            ...
            case "pisang":
              if (global.db.data.users[m.sender].pisang >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} pisang, dan anda mendapatkan ${
                    Spisang * count
                  } money`,
                  m
                );
            ...
            case "anggur":
              if (global.db.data.users[m.sender].anggur >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} anggur, dan anda mendapatkan ${
                    Sanggur * count
                  } money`,
                  m
                );
            ...
            case "jeruk":
              if (global.db.data.users[m.sender].jeruk >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} jeruk, dan anda mendapatkan ${
                    Sjeruk * count
                  } money`,
                  m
                );
            ...
            case "apel":
              if (global.db.data.users[m.sender].apel >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} apel, dan anda mendapatkan ${
                    Sapel * count
                  } money`,
                  m
                );
            ...
            case "berlian":
              if (global.db.data.users[m.sender].berlian >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} berlian, dan anda mendapatkan ${
                    Sberlian * count
                  } money`,
                  m
                );
            ...
            case "emas":
              if (global.db.data.users[m.sender].emas >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} emas , dan anda mendapatkan ${
                    Semasbiasa * count
                  } money`,
                  m
                );
            ...
            case "pet":
              if (global.db.data.users[m.sender].pet >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} pet random, dan anda mendapatkan ${
                    Spet * count
                  } money`,
                  m
                );
            ...
            case "makananpet":
              if (global.db.data.users[m.sender].makananpet >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} makanan pet, dan anda mendapatkan ${
                    Smakananpet * count
                  } money`,
                  m
                );
            ...
            case "makananphonix":
              if (global.db.data.users[m.sender].makananphonix >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} makanan phonix, dan anda mendapatkan ${
                    Smakananphonix * count
                  } money`,
                  m
                );
            ...
            case "makanannaga":
              if (global.db.data.users[m.sender].makanannaga >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} makanan naga, dan anda mendapatkan ${
                    Smakanannaga * count
                  } money`,
                  m
                );
            ...
            case "makanankyubi":
              if (global.db.data.users[m.sender].makanankyuni >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} makanan kyubi, dan anda mendapatkan ${
                    Smakanankyubi * count
                  } money`,
                  m
                );
            ...
            case "makanangriffin":
              if (global.db.data.users[m.sender].makanangriffin >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} makanan griffin, dan anda mendapatkan ${
                    Smakanangriffin * count
                  } money`,
                  m
                );
            ...
            case "makanancentaur":
              if (global.db.data.users[m.sender].makanancentaur >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} makanan centaur, dan anda mendapatkan ${
                    Smakanancentaur * count
                  } money`,
                  m
                );
            ...
            case "aqua":
              if (global.db.data.users[m.sender].aqua >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} aqua, dan anda mendapatkan ${
                    Saqua * count
                  } money`,
                  m
                );
            ...
            case "string":
              if (global.db.data.users[m.sender].string >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} string, dan anda mendapatkan ${
                    Sstring * count
                  } money`,
                  m
                );
            ...
            case "sword":
              if (global.db.data.users[m.sender].sword >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} sword, dan anda mendapatkan ${
                    Ssword * count
                  } money`,
                  m
                );
            ...
            case "batu":
              if (global.db.data.users[m.sender].batu >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} batu, dan anda mendapatkan ${
                    Sbatu * count
                  } money`,
                  m
                );
