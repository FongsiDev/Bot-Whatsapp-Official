let handler = async (m, { conn, command, args, usedPrefix }) => {
  ...
  let pppecat = [
    "Ruko Kebakaran",
    "LO NGOCOK DIDEPAN UMUM",
    "Males Malesan",
    "Ngew istrinya yg punya ruko",
  ];
  ...
  if (/kerjadulu|kerja|work/i.test(command)) {
    switch (type) {
      case "ojek":
        if (global.db.data.users[m.sender].ojek == false)
          throw "ini bukan tugas kamu atau kamu pengangguran!";
        if (new Date() - global.db.data.users[m.sender].lastkerja < 300000)
        ...
        break;
      case "pedagang":
        if (global.db.data.users[m.sender].pedagang == false)
          throw "ini bukan tugas kamu atau kamu pengangguran!";
        if (new Date() - global.db.data.users[m.sender].lastkerja < 300000)
        ...
        break;
      case "dokter":
        if (global.db.data.users[m.sender].dokter == false)
          throw "ini bukan tugas kamu atau kamu pengangguran!";
        if (new Date() - global.db.data.users[m.sender].lastkerja < 300000)
          throw `Kamu sudah bekerja,Saatnya istirahat selama\n🕜 ${clockString(
            time - new Date()
        ...
        break;
      case "petani":
        if (global.db.data.users[m.sender].petani == false)
          throw "ini bukan tugas kamu atau kamu pengangguran!";
        if (new Date() - global.db.data.users[m.sender].lastkerja < 300000)
          throw `Kamu sudah bekerja,Saatnya istirahat selama\n🕜 ${clockString(
            time - new Date()
        ...
        break;
      case "montir":
        if (global.db.data.users[m.sender].montir == false)
          throw "ini bukan tugas kamu atau kamu pengangguran!";
        if (new Date() - global.db.data.users[m.sender].lastkerja < 300000)
          throw `Kamu sudah bekerja,Saatnya istirahat selama\n🕜 ${clockString(
            time - new Date()
        ...
        break;
      case "kuli":
        if (global.db.data.users[m.sender].kuli == false)
          throw "ini bukan tugas kamu atau kamu pengangguran!";
        if (new Date() - global.db.data.users[m.sender].lastkerja < 300000)
          throw `Kamu sudah bekerja,Saatnya istirahat selama\n🕜 ${clockString(
            time - new Date()
