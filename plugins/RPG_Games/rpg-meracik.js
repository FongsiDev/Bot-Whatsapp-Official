...
let handler = async (m, { conn, args, usedPrefix, command, text }) => {
  ...
  switch (type) {
    case "ramuan":
      ...
      let __waktuga =
        new Date() - global.db.data.users[m.sender].lastramuanclaim;
      ...
      if (
        ...
        return m.reply(
          "*Pastikan kamu memiliki semua buah buahan*\n*Seperti Apel, Mangga, Jeruk, Pisang, Anggur*"
        );
      if (
        new Date() - global.db.data.users[m.sender].lastramuanclaim >
        600000
            ...
            if (global.db.data.users[m.sender].pisang > 499) {
              if (global.db.data.users[m.sender].jeruk > 499) {
                if (global.db.data.users[m.sender].anggur > 499) {
                  ...
                  global.db.data.users[m.sender].lastramuanclaim =
                    new Date() * 1;
                  let srcs = `
...
`.trim();
                  ...
                  setTimeout(() => {
                    conn.reply(
                      m.chat,
                      "Mohon tunggu sedang mengaduk ramuan",
                      m
                    );
                  }, timeoute);
                } else
                  m.reply(
                    `Pastikan anggur kamu *500* untuk bisa meracik ramuan`
                  );
              } else
                m.reply(`Pastikan jeruk kamu *500* untuk bisa meracik ramuan`);
            } else
              m.reply(`Pastikan pisang kamu *500* untuk bisa meracik ramuan`);
...
`.trim()
    ...
    case "potion":
      ...
      let __waktution =
        new Date() - global.db.data.users[m.sender].lastpotionclaim;
            ...
            if (global.db.data.users[m.sender].pisang > 499) {
              if (global.db.data.users[m.sender].jeruk > 499) {
                if (global.db.data.users[m.sender].anggur > 499) {
                  ...
                  global.db.data.users[m.sender].lastpotionclaim =
                    new Date() * 1;
                  let srcn = `
...
`.trim();
                  ...
                  setTimeout(() => {
                    conn.reply(
                      m.chat,
                      "Mohon tunggu sedang mengaduk potion",
                      m
                    );
                  }, timeouto);
                } else
                  m.reply(
                    `Pastikan anggur kamu *500* untuk bisa meracik potion`
                  );
              } else
                m.reply(`Pastikan jeruk kamu *500* untuk bisa meracik potion`);
            } else
              m.reply(`Pastikan pisang kamu *500* untuk bisa meracik potion`);
    ...
    case "string":
      ...
      let __waktutiong =
        new Date() - global.db.data.users[m.sender].laststringclaim;
            ...
            if (global.db.data.users[m.sender].pisang > 499) {
              if (global.db.data.users[m.sender].jeruk > 499) {
                if (global.db.data.users[m.sender].anggur > 499) {
                  ...
                  global.db.data.users[m.sender].laststringclaim =
                    new Date() * 1;
                  let srcng = `
...
`.trim();
                  ...
                  setTimeout(() => {
                    conn.reply(
                      m.chat,
                      "Mohon tunggu sedang mengaduk string",
                      m
                    );
                  }, timeoutol);
                } else
                  m.reply(
                    `Pastikan anggur kamu *500* untuk bisa meracik string`
                  );
              } else
                m.reply(`Pastikan jeruk kamu *500* untuk bisa meracik string`);
            } else
              m.reply(`Pastikan pisang kamu *500* untuk bisa meracik string`);
    ...
    case "sword":
      ...
      let __waktutions =
        new Date() - global.db.data.users[m.sender].lastswordclaim;
      let _waktutions = 600000 - __waktutions;
      let waktutions = clockString(_waktutions);
      if (iron == 0 || kayu == 0 || string == 0)
        return m.reply(
...
`.trim();
              ...
              m.reply(`Pastikan string kamu *10* untuk bisa meracik sword`);
    ...
    case "weapon":
      ...
      let __waktutionsw =
        new Date() - global.db.data.users[m.sender].lastweaponclaim;
      let _waktutionsw = 600000 - __waktutionsw;
      let waktutionsw = clockString(_waktutionsw);
      if (ironw == 0 || kayuw == 0 || stringw == 0 || swordw == 0)
        return m.reply(
...
`.trim();
                ...
                m.reply(`Pastikan sword kamu *10* untuk bisa meracik weapon`);
            } else
              m.reply(`Pastikan string kamu *10* untuk bisa meracik weapon`);
    ...
    case "iron":
      ...
      let __waktutionsk =
        new Date() - global.db.data.users[m.sender].lastsironclaim;
      let _waktutionsk = 600000 - __waktutionsk;
      let waktutionsk = clockString(_waktutionsk);
      if (emasbiasa == 0 || stringk == 0)
        return m.reply(
          "*Pastikan kamu memiliki semua*\n*Seperti Emas, String*"
        );
...
`.trim();
    ...
    case "pancingan":
      ...
      let __waktutionskh =
        new Date() - global.db.data.users[m.sender].lastsmancingclaim;
      let _waktutionskh = 600000 - __waktutionskh;
      let waktutionskh = clockString(_waktutionskh);
      if (kayuh == 0 || stringh == 0 || batuh == 0)
        return m.reply(
...
`.trim();
              ...
              if (pancingan > 0) {
                ...
                if (global.db.data.users[m.sender].anakpancingan > naiklvl) {
                  ...
                  global.db.data.users[m.sender].anakpancingan -=
                    pancingan * 10000;
                  conn.reply(m.chat, `*Selamat pancingan kamu naik level*`, m);
                }
              }
            } else
              m.reply(`Pastikan batu kamu *10* untuk bisa meracik pancingan`);
          } else
            m.reply(`Pastikan string kamu *5* untuk bisa meracik pancingan`);
    ...
    default:
      return conn.reply(
        ...
        `${
          usedPrefix + command
        } [ramuan | potion | string | iron | sword | weapon | pancingan]\nContoh penggunaan: *${
          usedPrefix + command
        } ramuan*`,
        m
      );
