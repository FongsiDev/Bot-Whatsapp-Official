let handler = async (m, { conn, usedPrefix, participants }) => {
  ...
  m.reply(
    `*Pet Kamu* (🐴centaur ${
      global.db.data.users[m.sender].centaur
    }) ⚔️menantang 🐴centaurnya *${conn.getName(lawan)}* (🐴centaur ${
      global.db.data.users[lawan].centaur
  ...
  if (pointPemain > pointLawan) {
    ...
    m.reply(
      `*${conn.getName(m.sender)}* [${pointPemain * 10}] - [${
        ...
        global.db.data.users[m.sender].centaur
      }) MENANG melawan 🐴centaurnya *${conn.getName(lawan)}* (centaur ${
        global.db.data.users[lawan].centaur
      }) karena centaur🐴kamu ${
    ...
    m.reply(
      `*${conn.getName(m.sender)}* [${pointPemain * 10}] - [${
        ...
        global.db.data.users[m.sender].centaur
      }) KALAH melawan 🐴centaurnya *${conn.getName(lawan)}* (centaur ${
        global.db.data.users[lawan].centaur
      }) karena pet kamu ${
