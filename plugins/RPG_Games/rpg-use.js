      ...
      try {
        ...
        if (args[0] === "potion") {
          if (global.db.data.users[m.sender].healt < 100) {
            if (global.db.data.users[m.sender].potion >= count * 1) {
              ...
              conn.sendButton(
                ...
                null,
                [
                  ["beli potion", usedPrefix + "beli potion"],
                  ["cek inv", usedPrefix + "inv"],
                ],
                m
              );
          } else
          ...
          conn.sendButton(
            ...
            null,
            [
              ["gunakan 1 potion", usedPrefix + "use potion 1"],
              ["gunakan 2 potion", usedPrefix + "use potion 2"],
            ],
            m
          );
      } catch (e) {
