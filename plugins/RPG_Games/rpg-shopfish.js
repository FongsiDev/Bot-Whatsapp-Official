          ...
          switch (_type) {
            case "hiu":
              if (global.db.data.users[m.sender].money >= Bhiu * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Hiu dengan harga ${
                    Bhiu * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} Hiu dengan harga ${
                    Bhiu * count
                  } money`.trim(),
                  m
                );
            ...
            case "ikan":
              if (global.db.data.users[m.sender].money >= Bikan * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Ikan dengan harga ${
                    Bikan * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} ikan dengan harga ${
                    Bikan * count
                  } money`.trim(),
                  m
                );
            ...
            case "dory":
              if (global.db.data.users[m.sender].money >= Bdory * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Dory dengan harga ${
                    Bdory * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} Dory dengan harga ${
                    Bdory * count
                  } money`.trim(),
                  m
                );
            ...
            case "orca":
              if (global.db.data.users[m.sender].money >= Borca * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Orca dengan harga ${
                    Borca * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} orca dengan harga ${
                    Borca * count
                  } money`.trim(),
                  m
                );
            ...
            case "paus":
              if (global.db.data.users[m.sender].money >= Bpaus * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Paus dengan harga ${
                    Bpaus * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} Paus dengan harga ${
                    Bpaus * count
                  } money`.trim(),
                  m
                );
            ...
            case "cumi":
              if (global.db.data.users[m.sender].money >= Bcumi * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Cumi dengan harga ${
                    Bcumi * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} Cumi dengan harga ${
                    Bcumi * count
                  } money`.trim(),
                  m
                );
            ...
            case "gurita":
              if (global.db.data.users[m.sender].money >= Bgurita * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Gurita dengan harga ${
                    Bgurita * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} Gurita dengan harga ${
                    Bgurita * count
                  } money`.trim(),
                  m
                );
            ...
            case "buntal":
              if (global.db.data.users[m.sender].money >= Bbuntal * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Buntal dengan harga ${
                    Bbuntal * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} Buntal dengan harga ${
                    Bbuntal * count
                  } money`.trim(),
                  m
                );
            ...
            case "udang":
              if (global.db.data.users[m.sender].money >= Budang * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Udang dengan harga ${
                    Budang * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} Udang dengan harga ${
                    Budang * count
                  } money`.trim(),
                  m
                );
            ...
            case "lumba":
              if (global.db.data.users[m.sender].money >= Blumba * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Lumba² dengan harga ${
                    Blumba * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} Lumba² dengan harga ${
                    Blumba * count
                  } money`.trim(),
                  m
                );
            ...
            case "lobster":
              if (global.db.data.users[m.sender].money >= Blobster * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Lobster dengan harga ${
                    Blobster * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} Lobster dengan harga ${
                    Blobster * count
                  } money`.trim(),
                  m
                );
            ...
            case "kepiting":
              if (global.db.data.users[m.sender].money >= Bkepiting * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli ${count} Kepiting dengan harga ${
                    Bkepiting * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang anda tidak cukup untuk membeli ${count} Kepiting dengan harga ${
                    Bkepiting * count
                  } money`.trim(),
                  m
                );
          ...
          switch (_type) {
            case "hiu":
              if (global.db.data.users[m.sender].hiu >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} hiu, dan anda mendapatkan ${
                    Shiu * count
                  } money`,
                  m
                );
            ...
            case "ikan":
              if (global.db.data.users[m.sender].ikan >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} ikan, dan anda mendapatkan ${
                    Sikan * count
                  } money`,
                  m
                );
            ...
            case "dory":
              if (global.db.data.users[m.sender].dory >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} dory, dan anda mendapatkan ${
                    Sdory * count
                  } money`,
                  m
                );
            ...
            case "orca":
              if (global.db.data.users[m.sender].orca >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} orca, dan anda mendapatkan ${
                    Sorca * count
                  } money`,
                  m
                );
            ...
            case "paus":
              if (global.db.data.users[m.sender].paus >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} paus, dan anda mendapatkan ${
                    Spaus * count
                  } money`,
                  m
                );
            ...
            case "cumi":
              if (global.db.data.users[m.sender].cumi >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} Cumi, dan anda mendapatkan ${
                    Scumi * count
                  } money`,
                  m
                );
            ...
            case "gurita":
              if (global.db.data.users[m.sender].gurita >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} Gurita, dan anda mendapatkan ${
                    Sgurita * count
                  } money`,
                  m
                );
            ...
            case "buntal":
              if (global.db.data.users[m.sender].buntal >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} Buntal, dan anda mendapatkan ${
                    Sbuntal * count
                  } money`,
                  m
                );
            ...
            case "udang":
              if (global.db.data.users[m.sender].udang >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} Udang, dan anda mendapatkan ${
                    Sudang * count
                  } money`,
                  m
                );
            ...
            case "lumba":
              if (global.db.data.users[m.sender].lumba >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} Lumba², dan anda mendapatkan ${
                    Slumba * count
                  } money`,
                  m
                );
            ...
            case "lobster":
              if (global.db.data.users[m.sender].lobster >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} Lobster, dan anda mendapatkan ${
                    Slobster * count
                  } money`,
                  m
                );
            ...
            case "kepiting":
              if (global.db.data.users[m.sender].kepiting >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} Kepiting, dan anda mendapatkan ${
                    Skepiting * count
                  } money`,
                  m
                );
