...
*◪ Upgrade ⏫*
*🥼 Armor:* ${uparmor} 💎 ${
    _armor == 0 ? "(Belum memiliki)" : _armor == 5 ? "( *Level max* )" : ""
  }
*🎣 Fishingrod:* ${uppancing} 💎
╰▸ *Durability:* ${durfishingrod} ${
    _pancing == 0 ? "(Belum memiliki)" : _pancing == 5 ? "( *Level max* )" : ""
  }
*⛏️ Pickaxe:* ${uppickaxe} 💎
╰▸ *Durability:* ${durpickaxe} ${
    _pickaxe == 0 ? "(Belum memiliki)" : _pickaxe == 5 ? "( *Level max* )" : ""
  }
*🗡️ Sword:* ${upsword} 💎
╰▸ *Durability:* ${dursword} ${
    _sword == 0 ? "(Belum memiliki)" : _sword == 5 ? "( *Level max* )" : ""
  }
⛊━━━┄┄┄┄┄┄┄┄┄━━━⛊
*◪ Repair 🔨*
*🎣 Fishingrod:* ${refishingrod} 💎 ${
    _pancing == 0 ? "(Belum memiliki)" : _pancing == 5 ? "( *Level max* )" : ""
  }
...
`.trim();
  try {
    if (/toko|buy/i.test(command)) {
      const count =
        args[2] && args[2].length > 0
          ? Math.min(99999999999999999999999, Math.max(parseInt(args[2]), 1))
      ...
      switch (jualbeli) {
        case "buy":
          switch (_type) {
            case "kucing":
              if (global.db.data.users[m.sender].kucing == 1)
                return conn.reply(m.chat, "Kamu sudah memiliki pet ini", m);
              if (global.db.data.users[m.sender].emas >= Bkucing * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli Pet Kucing 🐱 Dengan Harga ${
                    Bkucing * count
                  } Gold 🪙`,
                  m
                );
              ...
              break;
            case "anjing":
              if (global.db.data.users[m.sender].anjing == 1)
                return conn.reply(m.chat, "Kamu sudah memiliki pet ini", m);
              if (global.db.data.users[m.sender].emas >= Bkucing * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli Pet Anjing 🐶 Dengan Harga ${
                    Bkucing * count
                  } Gold 🪙`,
                  m
                );
              ...
              break;
            case "kuda":
              if (global.db.data.users[m.sender].kuda == 1)
                return conn.reply(m.chat, "Kamu sudah memiliki pet ini", m);
              if (global.db.data.users[m.sender].emas >= Bkuda * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli Pet Kuda 🐴 Dengan Harga ${
                    Bkuda * count
                  } Gold 🪙`,
                  m
                );
              ...
              break;
            case "fox":
              if (global.db.data.users[m.sender].rubah == 1)
                return conn.reply(m.chat, "Kamu sudah memiliki pet ini", m);
              if (global.db.data.users[m.sender].emas >= Bfox * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli Pet Rubah 🦊 Dengan Harga ${
                    Bfox * count
                  } Gold 🪙`,
                  m
                );
              ...
              break;
            case "serigala":
              if (global.db.data.users[m.sender].serigala == 1)
                return conn.reply(m.chat, "Kamu sudah memiliki pet ini", m);
              if (global.db.data.users[m.sender].emas >= Bserigala * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli Pet Serigala 🐺 Dengan Harga ${
                    Bserigala * count
                  } Gold 🪙`,
                  m
                );
              ...
              break;
            case "phonix":
              if (global.db.data.users[m.sender].phonix == 1)
                return conn.reply(m.chat, "Kamu sudah memiliki pet ini", m);
              if (global.db.data.users[m.sender].emas >= Bphonix * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli Pet Phonix 🦜 Dengan Harga ${
                    Bphonix * count
                  } Gold 🪙`,
                  m
                );
              ...
              break;
            case "centaur":
              if (global.db.data.users[m.sender].centaur == 1)
                return conn.reply(m.chat, "Kamu sudah memiliki pet ini", m);
              if (global.db.data.users[m.sender].emas >= Bcentaur * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli Pet Centaur 🐎 Dengan Harga ${
                    Bcentaur * count
                  } Gold 🪙`,
                  m
                );
              ...
              break;
            case "griffin":
              if (global.db.data.users[m.sender].griffin == 1)
                return conn.reply(m.chat, "Kamu sudah memiliki pet ini", m);
              if (global.db.data.users[m.sender].emas >= Bgriffin * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli Pet Griffin 🦅 Dengan Harga ${
                    Bgriffin * count
                  } Gold 🪙`,
                  m
                );
              ...
              break;
            case "naga":
              if (global.db.data.users[m.sender].naga == 1)
                return conn.reply(m.chat, "Kamu sudah memiliki pet ini", m);
              if (global.db.data.users[m.sender].emas >= Bnaga * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli Pet Naga 🐉 Dengan Harga ${
                    Bnaga * count
                  } Gold 🪙`,
                  m
                );
            ...
            case "foodpet":
              if (global.db.data.users[m.sender].money >= Bfood * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli FoodPet 🥩 Dengan Harga ${
                    Bfood * count
                  } Money 💹`,
                  m
                );
            ...
            case "potion":
              if (global.db.data.users[m.sender].money >= potion * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Potion 🥤 Dengan Harga ${
                    potion * count
            ...
            case `gold`:
              if (global.db.data.users[m.sender].money >= Bgold * count) {
                ...
                conn.reply(
                  m.chat,
                  `Sukses Membeli ${count} Gold 🪙 Dengan Harga ${
                    Bgold * count
                  } money`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang Anda Tidak Cukup Untuk Membeli ${count} Gold Dengan Harga ${
                    Bgold * count
                  } Money `
                );
              break;
            case "bibitmangga":
              if (global.db.data.users[m.sender].money >= Bjagung * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Bibit Mangga 🌾\nDengan Harga ${
                    Bapel * count
                  } money 💹`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang Anda Tidak Cukup Untuk Membeli ${count} Bibit Mangga 🌾\nDengan Harga ${
                    Bapel * count
                  } Money 💹`
                );
              break;
            case "bibitapel":
              if (global.db.data.users[m.sender].money >= Bapel * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Bibit Apel🌾\nDengan Harga ${
                    Bapel * count
                  } money 💹`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang Anda Tidak Cukup Untuk Membeli ${count} Bibit Apel 🌾\nDengan Harga ${
                    Bapel * count
                  } Money 💹`
                );
              break;
            case "bibitjeruk":
              if (global.db.data.users[m.sender].money >= Bapel * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Bibit Jeruk🌾\nDengan Harga ${
                    Bapel * count
                  } money 💹`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang Anda Tidak Cukup Untuk Membeli ${count} Bibit Jeruk 🌾\nDengan Harga ${
                    Bapel * count
                  } Money 💹`
                );
              break;
            case "bibitpisang":
              if (global.db.data.users[m.sender].money >= Bapel * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Bibit Pisang🌾\nDengan Harga ${
                    Bapel * count
                  } money 💹`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang Anda Tidak Cukup Untuk Membeli ${count} Bibit Pisang 🌾\nDengan Harga ${
                    Bapel * count
                  } Money 💹`
                );
              break;
            case "bibitanggur":
              if (global.db.data.users[m.sender].money >= Bapel * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Bibit Anggur🌾\nDengan Harga ${
                    Bapel * count
                  } money 💹`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang Anda Tidak Cukup Untuk Membeli ${count} Bibit Anggur 🌾\nDengan Harga ${
                    Bapel * count
                  } Money 💹`
                );
              break;
            case "diamond":
              if (global.db.data.users[m.sender].money >= Bdiamond * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Diamond 💎 Dengan Harga ${
                    Bdiamond * count
                  } Money 💹`,
                  m
                );
            ...
            case "batu":
              if (global.db.data.users[m.sender].money >= Bbatu * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Batu 🪨 Dengan Harga ${
                    Bbatu * count
                  } Money 💹`,
                  m
                );
            ...
            case "umpan":
              if (global.db.data.users[m.sender].money >= Bumpan * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Umpan 🪱 Dengan Harga ${
                    Bumpan * count
                  } Money 💹`,
                  m
                );
            ...
            case "kayu":
              if (global.db.data.users[m.sender].money >= Bkayu * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Kayu 🪵 Dengan Harga ${
                    Bkayu * count
                  } Money 💹`,
                  m
                );
            ...
            case "aqua":
              if (global.db.data.users[m.sender].money >= Baqua * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Aqua 🍶 Dengan Harga ${
                    Baqua * count
                  } Money 💹`,
                  m
                );
            ...
            case "string":
              if (global.db.data.users[m.sender].money >= Bstring * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} String 🕸️ Dengan Harga ${
                    Bstring * count
                  } Money 💹`,
                  m
                );
            ...
            case "iron":
              if (global.db.data.users[m.sender].money >= Biron * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Iron ⛓️ Dengan Harga ${
                    Biron * count
                  } Money 💹`,
                  m
                );
            ...
            case "common":
              if (global.db.data.users[m.sender].money >= Bcommon * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Common Crate 📦 Dengan Harga ${
                    Bcommon * count
                  } Money 💹`,
                  m
                );
            ...
            case "uncommon":
              if (global.db.data.users[m.sender].money >= Buncommon * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Uncommon Crate Dengan Harga ${
                    Buncommon * count
                  } Money 💹`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang Anda Tidak Cukup Untuk Membeli ${count} Uncommon Crate 🛍️ Dengan Harga ${
                    Buncommon * count
            ...
            case "mythic":
              if (global.db.data.users[m.sender].money >= Bmythic * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Mythic Crate 🎁 Dengan Harga ${
                    Bmythic * count
                  } Money 💹`,
                  m
                );
            ...
            case "legendary":
              if (global.db.data.users[m.sender].money >= Blegendary * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Legendary Crate 🧰 Dengan Harga ${
                    Blegendary * count
                  } Money 💹`,
                  m
                );
            ...
            case "pet":
              if (global.db.data.users[m.sender].money >= Bpet * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Pet Crate 📫 Dengan Harga ${
                    Bpet * count
                  } Money 💹`,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang Anda Tidak Cukup Untuk Membeli ${count} Pet Crate 📫 Dengan Harga ${
                    Bpet * count
                  } Money  💹\n\n📍 Buka Crate Dengan Ketik: *${usedPrefix}open legendary*`,
                  m
                );
            ...
            case "sampah":
              if (global.db.data.users[m.sender].money >= Bsampah * count) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli ${count} Sampah 🗑️ Dengan Harga ${
                    Bsampah * count
                  } Money 💹 `,
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `Uang Anda Tidak Cukup Untuk Membeli ${count} Sampah 🗑️ Dengan Harga ${
                    Bsampah * count
                  } Money 💹`.trim(),
                  m
                );
              ...
              break;
            case "armor":
              if (global.db.data.users[m.sender].armor == 1)
                return conn.reply(m.chat, "Kamu sudah memiliki Armor", m);
              if (global.db.data.users[m.sender].money > armor) {
                global.db.data.users[m.sender].armor += 1;
                global.db.data.users[m.sender].money -= armor * 1;
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli Armor 🥼 Seharga ${armor} Money`,
                  m
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang Mu Tidak Cukup Untuk Membeli Armor 🥼 Seharga ${armor} Money 💹`,
                  m
                );
            ...
            case "fishingrod":
              if (global.db.data.users[m.sender].pancing == 1)
                return conn.reply(m.chat, "Kamu sudah memiliki pancingan", m);
              if (global.db.data.users[m.sender].money > armor) {
                global.db.data.users[m.sender].pancing += 1;
                global.db.data.users[m.sender].money -= armor * 1;
                global.db.data.users[m.sender].fishingroddurability =
                  durfishingrod;
                conn.reply(
                  m.chat,
                  `✔️ Sukses Membeli Pancingan 🎣 Seharga ${pancing} Money`,
                  m
                );
              } else
                conn.reply(
                  m.chat,
                  `Uang Mu Tidak Cukup Untuk Membeli Pancingan 🎣 Seharga ${pancing} Money 💹`,
                  m
                );
          ...
          switch (_type) {
            case "potion":
              if (global.db.data.users[m.sender].potion >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Potion 🥤 Dengan Harga ${
                    Spotion * count
                  } Money 💹 `.trim(),
                  m
                );
            ...
            case "gold":
              if (global.db.data.users[m.sender].gold >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Gold 🪙 Dengan Harga ${
                    Sgold * count
                  } Money 💹`.trim(),
                  m
                );
            ...
            case "arloji":
              if (global.db.data.users[m.sender].arlok >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Arloji 🧭 Dengan Harga ${
                    Sarloji * count
                  } Money 💹`.trim(),
                  m
                );
            ...
            case "batu":
              if (global.db.data.users[m.sender].batu >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Batu 🪨 Dengan Harga ${
                    Sbatu * count
                  } Money 💹`.trim(),
                  m
                );
            ...
            case "kayu":
              if (global.db.data.users[m.sender].kayu >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Kayu 🪵 Dengan Harga ${
                    Skayu * count
                  } Money 💹`.trim(),
                  m
                );
            ...
            case "string":
              if (global.db.data.users[m.sender].string >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} String 🕸️ Dengan Harga ${
                    Sstring * count
                  } Money 💹`.trim(),
                  m
                );
            ...
            case "iron":
              if (global.db.data.users[m.sender].iron >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Iron ⛓️ Dengan Harga ${
                    Siron * count
                  } Money 💹`.trim(),
                  m
                );
            ...
            case "common":
              if (global.db.data.users[m.sender].common >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Common Crate 📦 Dengan Harga ${
                    Scommon * count
                  } Money 💹`.trim(),
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `📦 Common Crate Kamu Tidak Cukup`.trim(),
                  m
                );
              break;
            case "uncommon":
              if (global.db.data.users[m.sender].uncommon >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Uncommon Crate 🛍️ Dengan Harga ${
                    Suncommon * count
                  } Money 💹`.trim(),
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `🛍️ Uncommon Crate Kamu Tidak Cukup`.trim(),
                  m
                );
              break;
            case "mythic":
              if (global.db.data.users[m.sender].mythic >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Mythic Crate 🎁 Dengan Harga ${
                    Smythic * count
                  } Money 💹`.trim(),
                  m
                );
                ...
                conn.reply(
                  m.chat,
                  `🎁 Mythic Crate Kamu Tidak Cukup `.trim(),
                  m
                );
              break;
            case "legendary":
              if (global.db.data.users[m.sender].legendary >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Legendary Crate 🧰 Dengan Harga ${
                    Slegendary * count
                  } Money 💹`.trim(),
                  m
                );
            ...
            case "pet":
              if (global.db.data.users[m.sender].pet >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Pet Crate 📫 Dengan Harga ${
                    Spet * count
                  } Money 💹`.trim(),
                  m
                );
              } else
                conn.reply(m.chat, `📫 Pet Crate Kamu Tidak Cukup `.trim(), m);
              break;
            case "sampah":
              if (global.db.data.users[m.sender].sampah >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Sampah 🗑️ Dengan Harga ${
                    Ssampah * count
                  } Money 💹`,
                  m
                );
            ...
            case "diamond":
              if (global.db.data.users[m.sender].diamond >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Diamond 💎 Dengan Harga ${
                    Sdiamond * count
                  } Money 💹`,
                  m
                );
            ...
            case "mangga":
              if (global.db.data.users[m.sender].mangga >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Mangga 🥭 Dengan Harga ${
                    Smangga * count
                  } Money 💹`,
                  m
                );
            ...
            case "apel":
              if (global.db.data.users[m.sender].apel >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Apel 🍎 Dengan Harga ${
                    Smangga * count
                  } Money 💹`,
                  m
                );
            ...
            case "jeruk":
              if (global.db.data.users[m.sender].jeruk >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Jeruk 🍊 Dengan Harga ${
                    Smangga * count
                  } Money 💹`,
                  m
                );
            ...
            case "anggur":
              if (global.db.data.users[m.sender].anggur >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Anggur 🍇 Dengan Harga ${
                    Smangga * count
                  } Money 💹`,
                  m
                );
            ...
            case "pisang":
              if (global.db.data.users[m.sender].pisang >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Menjual ${count} Pisang 🍌 Dengan Harga ${
                    Smangga * count
                  } Money 💹`,
                  m
                );
          ...
          switch (_type) {
            case "armor":
              ...
              if (global.db.data.users[m.sender].armor == 0)
                return conn.reply(m.chat, "Kamu belum mempunyai Armor", m);
              if (global.db.data.users[m.sender].diamond > uparmor) {
                global.db.data.users[m.sender].armor += 1;
                global.db.data.users[m.sender].diamond -= uparmor * 1;
                conn.reply(
                  m.chat,
                  `✔️ Sukses Mengupgrade Armor 🥼 Seharga ${uparmor} Diamond 💎`,
                  m
                );
              } else
                conn.reply(
                  m.chat,
                  `Diamond Mu Tidak Cukup Untuk Mengupgrade Armor 🥼 Seharga ${uparmor} Diamond 💎`,
                  m
                );
            ...
            case "fishingrod":
              if (global.db.data.users[m.sender].fishingrod == 4)
                return conn.reply(m.chat, "Pancingan mu udah *Level Max*", m);
              if (global.db.data.users[m.sender].fishingrod == 0)
                return conn.reply(m.chat, "Kamu belum mempunyai Pancingan", m);
              if (global.db.data.users[m.sender].diamond > uppancing) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Mengupgrade Fishingrod 🎣  Seharga ${uppancing} Diamond 💎`,
                  m
                );
              } else
                conn.reply(
                  m.chat,
                  `Diamond Mu Tidak Cukup Untuk Mengupgrade Fishingrod 🎣  Seharga ${uppancing} Diamond 💎`,
                  m
                );
            ...
            case "sword":
              if (global.db.data.users[m.sender].sword == 5)
                return conn.reply(m.chat, "Sword mu udah *Level Max*", m);
              if (global.db.data.users[m.sender].sword == 0)
                return conn.reply(m.chat, "Kamu belum mempunyai Sword", m);
              if (global.db.data.users[m.sender].diamond > upsword) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Mengupgrade Sword 🗡️ Seharga ${upsword} Diamond 💎`,
                  m
                );
              } else
                conn.reply(
                  m.chat,
                  `Diamond Mu Tidak Cukup Untuk Mengupgrade Sword 🗡️ Seharga ${upsword} Diamond 💎`,
                  m
                );
              break;
            case "pickaxe":
              if (global.db.data.users[m.sender].pickaxe == 5)
                return conn.reply(m.chat, "Pickaxe mu udah *Level Max*", m);
              if (global.db.data.users[m.sender].pickaxe == 0)
                return conn.reply(m.chat, "Kamu belum mempunyai Pickaxe", m);
              if (global.db.data.users[m.sender].diamond > uppickaxe) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Mengupgrade Pickaxe ⛏️ Seharga ${uppickaxe} Diamond 💎`,
                  m
                );
              } else
                conn.reply(
                  m.chat,
                  `Diamond Mu Tidak Cukup Untuk Mengupgrade Pickaxe ⛏️  Seharga ${uppickaxe} Diamond 💎`,
                  m
                );
              break;
            default:
        ...
        case "repair":
          switch (_type) {
            case "fishingrod":
              if (global.db.data.users[m.sender].fishingroddurability == 80)
                return conn.reply(
                  m.chat,
                  "Pancingan mu belum ada kerusakan",
                  m
                );
              if (global.db.data.users[m.sender].fishingrod == 0)
                return conn.reply(m.chat, "Kamu belum mempunyai Pancingan", m);
              if (global.db.data.users[m.sender].diamond > refishingrod) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Mengrepair Fishingrod 🎣  Seharga ${refishingrod} Diamond 💎\n➕ ${drefishingrod} Durability`,
                  m
                );
              } else
                conn.reply(
                  m.chat,
                  `Diamond Mu Tidak Cukup Untuk Merepair Fishingrod 🎣  Seharga ${refishingrod} Diamond 💎`,
                  m
                );

              break;
            case "pickaxe":
              if (global.db.data.users[m.sender].pickaxedurability == 80)
                return conn.reply(m.chat, "Pickaxe mu belum ada kerusakan", m);
              if (global.db.data.users[m.sender].pickaxe == 0)
                return conn.reply(m.chat, "Kamu belum mempunyai Pickaxe", m);
              if (global.db.data.users[m.sender].diamond > repickaxe) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Mengrepair Pickaxe ⛏️ Seharga ${repickaxe} Diamond 💎\n➕ ${drepickaxe} Durability`,
                  m
                );
              } else
                conn.reply(
                  m.chat,
                  `Diamond Mu Tidak Cukup Untuk Merepair Pickaxe ⛏️  Seharga ${repickaxe} Diamond 💎`,
                  m
                );

              break;
            case "sword":
              if (global.db.data.users[m.sender].sworddurability == 80)
                return conn.reply(m.chat, "Sword mu belum ada kerusakan", m);
              if (global.db.data.users[m.sender].sword == 0)
                return conn.reply(m.chat, "Kamu belum mempunyai Sword", m);
              if (global.db.data.users[m.sender].diamond > resword) {
                ...
                conn.reply(
                  m.chat,
                  `✔️ Sukses Mengrepair Sword 🗡️ Seharga ${resword} Diamond 💎\n➕ ${dresword} Durability`,
                  m
                );
              } else
                conn.reply(
                  m.chat,
                  `Diamond Mu Tidak Cukup Untuk Merepair Sword 🗡️  Seharga ${resword} Diamond 💎`,
                  m
                );
      ...
      switch (type) {
        case "potion":
          if (global.db.data.users[m.sender].money >= potion * count) {
            ...
            conn.reply(
              m.chat,
              `Sukses membeli ${count} Potion Dengan Harga ${
                potion * count
              } Money \n\nGunakan Potion Dengan Ketik: *${usedPrefix}use potion <jumlah>*`,
              m
            );
        ...
        case "tprem":
          if (global.db.data.users[m.sender].money >= Btprem * count) {
            ...
            conn.reply(
              m.chat,
              `Sukses Membeli ${count} Tiket Premium Dengan Harga ${
                Btprem * count
              } Money`,
              m
            );
        ...
        case "diamond":
          if (global.db.data.users[m.sender].money >= Bdiamond * count) {
            ...
            conn.reply(
              m.chat,
              `Sukses Membeli ${count} Diamond Dengan Harga ${
                Bdiamond * count
              } Money `,
              m
            );
        ...
        case "common":
          if (global.db.data.users[m.sender].money >= Bcommon * count) {
            ...
            conn.reply(
              m.chat,
              `Sukses Membeli ${count} Common Crate Dengan Harga ${
                Bcommon * count
              } Money `,
              m
            );
        ...
        case "uncommon":
          if (global.db.data.users[m.sender].money >= Buncommon * count) {
            ...
            conn.reply(
              m.chat,
              `Sukses Membeli ${count} Uncommon Crate Dengan Harga ${
                Buncommon * count
              } Money `,
              m
            );
        ...
        case "mythic":
          if (global.db.data.users[m.sender].money >= Bmythic * count) {
            ...
            conn.reply(
              m.chat,
              `Sukses Membeli ${count} Mythic Crate Dengan Harga ${
                Bmythic * count
              } Money `,
              m
            );
        ...
        case "legendary":
          if (global.db.data.users[m.sender].money >= Blegendary * count) {
            ...
            conn.reply(
              m.chat,
              `Sukses Membeli ${count} Legendary Crate Dengan Harga ${
                Blegendary * count
              } Money`,
              m
            );
        ...
        case "sampah":
          if (global.db.data.users[m.sender].money >= Bsampah * count) {
            ...
            conn.reply(
              m.chat,
              `Sukses Membeli ${count} Sampah Dengan Harga ${
                Bsampah * count
              } money`,
              m
            );
        ...
        case "armor":
          if (global.db.data.users[m.sender].armor == 5)
            return conn.reply(m.chat, "Armormu Telah *Level Max*", m);
          if (global.db.data.users[m.sender].money > armor * 1) {
            global.db.data.users[m.sender].armor += 1;
            global.db.data.users[m.sender].money -= armor * 1;
            conn.reply(
              m.chat,
              `Sukses Membeli Armor Seharga ${armor} Money`,
              m
            );
          } else
            conn.reply(
      ...
      switch (type) {
        case "potion":
          if (global.db.data.users[m.sender].potion >= count * 1) {
            ...
            conn.reply(
              m.chat,
              `Sukses Menjual ${count} Potion Dengan Harga ${
                Spotion * count
              } Money`.trim(),
              m
            );
        ...
        case "common":
          if (global.db.data.users[m.sender].common >= count * 1) {
            ...
            conn.reply(
              m.chat,
              `Sukses Menjual ${count} Common Crate Dengan Harga ${
                Scommon * count
              } Money`.trim(),
              m
            );
        ...
        case "uncommon":
          if (global.db.data.users[m.sender].uncommon >= count * 1) {
            ...
            conn.reply(
              m.chat,
              `Sukses Menjual ${count} Uncommon Crate Dengan Harga ${
                Suncommon * count
              } Money`.trim(),
              m
            );
        ...
        case "mythic":
          if (global.db.data.users[m.sender].mythic >= count * 1) {
            ...
            conn.reply(
              m.chat,
              `Sukses Menjual ${count} Mythic Crate Dengan Harga ${
                Smythic * count
              } Money`.trim(),
              m
            );
        ...
        case "legendary":
          if (global.db.data.users[m.sender].legendary >= count * 1) {
            ...
            conn.reply(
              m.chat,
              `Sukses Menjual ${count} Legendary Crate Dengan Harga ${
                Slegendary * count
              } Money`.trim(),
              m
            );
        ...
        case "sampah":
          if (global.db.data.users[m.sender].sampah >= count * 1) {
            ...
            conn.reply(
              m.chat,
              `Sukses Menjual ${count} Sampah, Dan Anda Mendapatkan ${
                Ssampah * count
              } Money`.trim(),
              m
            );
        ...
        case "diamond":
          if (global.db.data.users[m.sender].diamond >= count * 1) {
            ...
            conn.reply(
              m.chat,
              `Sukses Menjual ${count} Diamond, Dan Anda Mendapatkan ${
                Sdiamond * count
              } Money`,
              m
            );
      ...
      switch (type) {
        case "armor":
          ...
          if (global.db.data.users[m.sender].diamond > uparmor) {
            ...
            conn.reply(
              m.chat,
              `✔️ Sukses Mengupgrade Armor 🥼 Seharga ${uparmor} Money`,
              m
            );
          } else
            conn.reply(
              m.chat,
              `Uang Mu Tidak Cukup Untuk Mengupgrade Armor 🥼 Seharga ${uparmor} Money 💹`,
              m
            );
    ...
    conn.sendButton(m.chat, Kchat, wm, null, [["Ngechit", ".ngechit"]], m, {
      contextInfo: {
        externalAdReply: {
          showAdAttribution: true,
          mediaUrl: sig,
