  ...
  const sections = [
    {
      ...
      rows: [
        ...
        {
          title: "🗣️ | Auto Vn (simi-simi)",
          rowId: `${usedPrefix + command} autovn`,
        },
        { title: "🔞 | Nsfw", rowId: `${usedPrefix + command} nsfw` },
        {
          title: "🌟 | PremNsfwChat",
          rowId: `${usedPrefix + command} premnsfwchat`,
        },
        ...
        {
          title: "👤 | WhiteListMyContact",
          rowId: `${usedPrefix + command} whitelistmycontact`,
        },
