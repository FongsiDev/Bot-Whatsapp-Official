let handler = async (m, { conn, args, usedPrefix }) => {
  ...
  switch (type) {
    case "rubah":
      ...
      let __waktur =
        new Date() - global.db.data.users[m.sender].ramuanrubahlast;
      ...
      if (
        ...
        m.reply(`Pet kamu sudah meminum ramuan, coba beberapa ${waktur} lagi`);
      break;
    case "kuda":
      ...
      if (new Date() - global.db.data.users[m.sender].ramuankudalast > 600000) {
        ...
        m.reply(`Pet kamu sudah meminum ramuan, coba beberapa ${waktuk} lagi`);
      break;
    case "serigala":
      if (serigala == 0) return m.reply("*Kamu belum memiliki Pet Serigala*");
      if (serigala == 15) return m.reply("*Pet kamu dah lvl max*");
      let __waktus =
        new Date() - global.db.data.users[m.sender].ramuanserigalalast;
      ...
      if (
        ...
        m.reply(`Pet kamu sudah meminum ramuan, coba beberapa ${waktus} lagi`);
      break;
    case "naga":
      ...
      if (new Date() - global.db.data.users[m.sender].ramuannagalast > 600000) {
        ...
        m.reply(`Pet kamu sudah meminum ramuan, coba beberapa ${waktug} lagi`);
      break;
    case "kyubi":
      if (kyubi == 0) return m.reply("*Kamu belum memiliki Pet kyubi*");
      if (kyubi == 20) return m.reply("*Pet kamu dah lvl max*");
      let __waktuyu =
        new Date() - global.db.data.users[m.sender].ramuankyubilast;
      ...
      if (
        ...
        m.reply(`Pet kamu sudah meminum ramuan, coba beberapa ${waktuyu} lagi`);
      break;
    case "centaur":
      if (centaur == 0) return m.reply("*Kamu belum memiliki Pet centaur*");
      if (centaur == 20) return m.reply("*Pet kamu dah lvl max*");
      let __waktuur =
        new Date() - global.db.data.users[m.sender].ramuancentaurlast;
      ...
      if (
        ...
        m.reply(`Pet kamu sudah meminum ramuan, coba beberapa ${waktuur} lagi`);
      break;
    case "phonix":
      if (phonix == 0) return m.reply("*Kamu belum memiliki Pet Phonix*");
      if (phonix == 15) return m.reply("*Pet kamu dah lvl max*");
      let __waktux =
        new Date() - global.db.data.users[m.sender].ramuanphonixlast;
    ...
    case "griffin":
      ...
      let __waktufin =
        new Date() - global.db.data.users[m.sender].ramuangriffinlast;
      ...
      if (
        ...
        m.reply(
          `Pet kamu sudah meminum ramuan, coba beberapa ${waktufin} lagi`
        );
      break;
    case "kucing":
      ...
      let __waktu =
        new Date() - global.db.data.users[m.sender].ramuankucinglast;
      ...
      if (
        ...
        m.reply(`Pet kamu sudah meminum ramuan, coba beberapa ${waktu} lagi`);
      break;
    case "hero":
      if (hero == 0) return m.reply("*Kamu belum memiliki Hero*");
      if (hero == 100) return m.reply("*Hero kamu dah lvl max*");
      let __waktuher =
        new Date() - global.db.data.users[m.sender].ramuanherolast;
      ...
      if (new Date() - global.db.data.users[m.sender].ramuanherolast > 600000) {
        ...
        m.reply(
          `Hero kamu sudah meminum ramuan, coba beberapa ${waktuher} lagi`
        );
      break;
    default:
      return conn.reply(
        m.chat,
        `${usedPrefix}ramuan [hero | kucing | rubah | kuda | naga | centaur | phonix | serigala]\nContoh penggunaan: *${usedPrefix}ramuan kucing*`,
        m
      );
  }
};
