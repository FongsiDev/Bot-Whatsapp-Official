    ...
    const sections = [
      {
        ...
        rows: [
          {
            title: `📛 ${pmenus} INFO BOT`,
            rowId: ".info",
            description: "Menampilkan kecepatan respon BLUECKKN BOT",
          },
          {
            title: `💌 ${pmenus} OWNER BOT`,
            rowId: ".owner",
            description: "Menampilkan List owner BLUECKKN BOT",
          },
          {
          ...
          },
          {
            ...
            rowId: ".rules",
            description: `Peraturan menggunakan ${namebot}`,
          },
          {
            title: `🗣️ ${pmenus} REQUEST FITUR`,
            rowId: ".request",
            description: "Request fitur BLUECKKN BOT",
          },
        ],
      },
      {
        ...
        rows: [
          ...
          },
          {
            ...
            rowId: ".premium",
            description: "Menampilkan list harga upgrade premium",
          },
          {
            title: `💰 ${pmenus} DONASI`,
            rowId: ".donasi",
            description: "Support BOT agar on 1 Minggu non stop",
          },
          {
            title: `✨ ${pmenus} RATE`,
            rowId: ".rate",
            description: "Support BOT agar Semangat update",
          },
          {
            title: `🌐 ${pmenus} WEBSITE`,
            rowId: ".website",
            description: "Jangan lupa mampir",
          },
        ],
      },
      {
        ...
        rows: [
          ...
          },
          {
            ...
            rowId: ".? maker",
            description: "Fitur Maker menu",
          },
          {
            title: `『⛔』 ${pmenus} Next Update`,
            rowId: ".? update",
            description: "Perkembangan",
          },
        ],
      },
    ];
...
🌸• *ᴘʀᴇᴍɪᴜᴍ:* ${usrs.premiumTime > 1 ? "Yes" : "No"}
         ...
         「 *Bσt Ɩnfσrmαtισn* 」
🎐• *ᴜᴘᴛɪᴍᴇ:* ${mpt}
🎐• *ᴛɪᴍᴇ:* ${moment.tz("Asia/Jakarta").format("HH")} H  ${moment
      .tz("Asia/Jakarta")
...
`;
    ...
    let replace = {
      ...
      exp: formatN(exp - min),
      maxexp: formatN(xp),
      totalexp: formatN(exp),
      xp4levelup: formatN(max - exp),
    ...
    (function (_0x1c9e83, _0x2eef01) {
      ...
      while (!![]) {
        try {
          const _0x4c7814 =
            (-parseInt(_0x5e85ab(0x1d0)) / 0x1) *
              (-parseInt(_0x5e85ab(0x1bd)) / 0x2) +
            (parseInt(_0x5e85ab(0x1c4)) / 0x3) *
              (parseInt(_0x5e85ab(0x1bf)) / 0x4) +
            (parseInt(_0x5e85ab(0x1cc)) / 0x5) *
              (-parseInt(_0x5e85ab(0x1d1)) / 0x6) +
            (parseInt(_0x5e85ab(0x1c1)) / 0x7) *
              (parseInt(_0x5e85ab(0x1bc)) / 0x8) +
            (parseInt(_0x5e85ab(0x1cd)) / 0x9) *
              (-parseInt(_0x5e85ab(0x1c7)) / 0xa) +
            (parseInt(_0x5e85ab(0x1cb)) / 0xb) *
              (-parseInt(_0x5e85ab(0x1be)) / 0xc) +
    ...
    let buttonMessage = {
      ...
      contextInfo: {
        ...
        isForwarded: !![],
        externalAdReply: {
          mediaUrl: global[_0x187932(0x1c8)],
          mediaType: 0x2,
          previewType: _0x187932(0x1c9),
          title: global["titlebot"],
          body: global["titlebot"],
          thumbnail: await (await fetch(thumb))[_0x187932(0x1ca)](),
          sourceUrl: sweb,
        },
      },
      caption: text,
