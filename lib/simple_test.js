...
END:VCARD`.trim();
    ...
    sendButtonDoc: {
      ...
      async value(jid, content, footerText, button1, id1, quoted, options) {
        ...
        const buttonMessage = {
          document: { url: "https://wa.me/6289503433262" },
          mimetype: global.doc,
      ...
      async value(jid, message, forwardingScore = true, options = {}) {
        ...
        if (
          ...
          message.message = proto.Message.fromObject(
            JSON.parse(
              JSON.stringify(message.message.viewOnceMessageV2.message)
            )
          );
          message.message[vtype].contextInfo =
            message.message.viewOnceMessageV2.contextInfo;
        }
