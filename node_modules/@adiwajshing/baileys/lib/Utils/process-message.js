    ...
    if (protocolMsg) {
        ...
        switch (message.messageStubType) {
            ...
            case Types_1.WAMessageStubType.GROUP_MEMBERSHIP_JOIN_APPROVAL_MODE:
                const membershipApprovalMode = (_h = message.messageStubParameters) === null || _h === void 0 ? void 0 : _h[0];
        ...
        if (pollMsg) {
            ...
            const pollEncKey = (_j = pollMsg.messageContextInfo) === null || _j === void 0 ? void 0 : _j.messageSecret;
            try {
