...
describe('Others', () => {
    ...
    describe('Minecraft', () => {
        it('Minecraft java', done => {
            (0, index_js_1.statusJava)('play.jackpotmc.com', 25565).then(res => {
                (0, chai_1.expect)(res).to.be.an('object');
                (0, chai_1.expect)(res.ip).to.be.a('string');
                (0, chai_1.expect)(res.port).to.be.a('number');
                (0, chai_1.expect)(res.description).to.be.a('string');
                (0, chai_1.expect)(res.descriptionText).to.be.a('string');
                (0, chai_1.expect)(res.players).to.be.an('object');
                (0, chai_1.expect)(res.players.max).to.be.a('number');
                (0, chai_1.expect)(res.players.online).to.be.a('number');
                (0, chai_1.expect)(res.players.sample).to.be.an('array');
                (0, chai_1.expect)(res.version).to.be.an('object');
                (0, chai_1.expect)(res.version.name).to.be.a('string');
                (0, chai_1.expect)(res.version.protocol).to.be.a('number');
                (0, chai_1.expect)(res.favicon).to.be.a('string');
                return done();
            }).catch(done);
        });
    });
    ...
    describe('sfilemobi', () => {
        it('sfilemobi search', done => {
            (0, index_js_1.sfilemobiSearch)('minecraft').then(res => {
                // console.log(res)
                return done();
            }).catch(done);
        });
        it('sfilemobi download', done => {
            (0, index_js_1.sfilemobi)('https://sfile.mobi/oGm8kAIQCs7').then(res => {
                // console.log(res)
                return done();
            }).catch(done);
        });
