...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`;
      ...
      case "donateg2vv":
        {
          hisoka.sendMessage(
            ...
            {
              image: {
                url: "https://telegra.ph/file/2ca88d3a03820f4d55673.png",
              },
              caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 13k Per Group via E-Walet 1 Month\n⭔ 18k via pulsa 1 Month\n\n Premium Price Bot\n⭔ 8k per User 1 bulan\n\nPayment can be via Paypal/link aja/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6289503433262 (Owner)\n\nDonate For Me : \n\n⭔ Saweria : https://saweria.co/foughtyew119206`,
            },
            { quoted: m }
          );
        }
      ...
      case "sc":
        {
          m.reply(
            "Script : https://github.com/Fongsi\n\n Dont Forget Give Star\n\nDonate : 6289503433262 (Link Aja)\nSaweria : https://saweria.co/foughtyew119206\n\n Dont Forget Donate"
          );
        }
        break;
      case "chat":
      ...
      case "bcgroup":
        {
          if (!isCreator) throw mess.owner;
          if (!text)
            throw `Text mana?\n\nExample : ${prefix + command} fongsi-san`;
            ...
            let btn = [
              {
                urlButton: {
                  ...
                  url: "https://github.com/Fongsi",
                },
              },
              {
                callButton: {
                  displayText: "Number Phone Owner",
                  phoneNumber: "+62 895-0343-3262",
                },
              },
              {
                quickReplyButton: {
